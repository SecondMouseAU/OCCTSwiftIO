...
// OCCTSwiftIO
//
// Wraps OCCTSwift export functionality for OBJ, PLY, STEP, BREP, and glTF/GLB
// formats. Headless — produces files from `Shape`, no Viewport dep.
...
/// Manages exporting shapes to mesh / B-Rep / glTF file formats.
